...
const JOB_DESCRIPTIONS = {
    ...
    "巫女": "日本の神社で神職の補助などを行う職業です<br>観光地などでは外国人の対応スキルが求められます。",
    ...
    "車掌": "電車の運行を安全に進めるための業務を担当する鉄道職員です。<br>サービス業務も多くあり、観光地などでは外国人の対応スキルが求められます。",
    ...
    "タクシー運転手": "乗客を目的地まで安全に届ける仕事です<br>接客マナーや交通の知識が必要になります。",
...
// 平均年収
const Nensyuu = [
    "470万円", "550万円", "1436万円", "390万円", "425万円",
    "300～600万円", "500万円", "810万円", "577万円", "380万円",
    "950万円", "700万円", "650万円", "420万円", "400万円",
    "400万円", "400万円", "350万円", "600万円", "550万円",
    "？？？", "？？？", "？？？", "？？？", "380万円",
    "340万円", "500万円", "？？？", "？？？", "400～600万円",
    "440万円", "500万円", "415万円", "400～800万円", "350万円",
...
// 画像をクリックした時にコメントを表示する処理
document.querySelector('.miko-image').addEventListener('click', function() {
    const comment = document.getElementById('miko-comment');
